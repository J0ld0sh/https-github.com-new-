...
mode.add_radiobutton(label='endless mode', var=dif, value=0, command=game)   # menu setting
mode.add_radiobutton(label='easy mode', var=dif, value=1, command=game)
mode.add_radiobutton(label='hardcore', var=dif, value=2, command=game)
menu.add_command(label='Новая игра', command=game)
